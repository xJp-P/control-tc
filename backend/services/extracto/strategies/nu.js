...
module.exports = {
  ...
  reglasPrompt() {
    return [
      'N1. Nu (franquicia Mastercard) usa un extracto UNICO en COP con formato NARRATIVO (un "Resumen de tu extracto" en prosa: Deuda + Intereses + Comisiones - Abonos = Pago Minimo). NO hay seccion USD ni "compra internacional" con interes especial estilo Bancolombia (no existe INT INTL). Las compras del exterior ya vienen convertidas a COP. Por eso "tasas_intl_extracto" debe ser {} (vacio) y NUNCA reportes discrepancias de clasificacion internacional.',
