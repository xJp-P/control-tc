...
- **Reprogramación de saldo ("Sellar y Renacer")** — cuando el banco cambia el plan de cuotas de una compra que ya facturó algunas (ej. de 12 a 2), la app sella las cuotas ya facturadas como registros congelados —el extracto pasado nunca se reescribe— y el saldo vivo renace con el plan nuevo. El capital se conserva al peso (la deuda y el cupo no cambian; solo se recalcula el interés al haber menos cuotas). Toda deuda que nace de una reprogramación vive en Diferidas, incluso si queda una sola cuota, etiquetada según el plan del banco ("Cuota 2/2"). El plan reprogramado puede llevar **cuotas de distinto tamaño**: al reducir el número de cuotas el banco no re-amortiza uniforme —conserva la cuota base del plan original y comprime lo que falta en la **siguiente cuota a facturar** (medido: 4×$11.225 → $11.225 / $22.450 / $11.225)—, y la reprogramación puede declararse efectiva en el **ciclo ya facturado** en vez del vigente, que es lo que corresponde al conciliar un extracto que siempre llega después de su corte. Ambas cosas se declaran **desde la interfaz**: el formulario de reprogramar tiene campo para el plan original (vacío = reparto uniforme) y para el ciclo efectivo, y la conciliación IA los manda sola — con el capital que factura el extracto, el backend **deduce** el plan original probando planes hasta reproducir esa cifra exacta
...
- **Saldos a favor** — cuando un reverso del banco devuelve una compra que el tercero ya había reembolsado, cuando una reprogramación elimina cuotas que él ya había adelantado, o cuando se **anula** una compra que él ya había adelantado, ese dinero **no se aplica solo**: nace como crédito a su nombre, trazable hasta la compra de origen, para cruzarlo manualmente contra otra deuda suya (nunca entre personas distintas) o liquidarlo. Cada cruce queda en un ledger auditable y se puede deshacer
