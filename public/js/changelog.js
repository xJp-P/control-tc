...
const CHANGELOG = {
  '6.5.0': [
    ...
    'LA COMPRA QUE EL BANCO ANULA YA NO SE LEE COMO "PAGADA". Al anularla el programa la deja sin deuda por dentro, y por esa puerta la tabla la anunciaba como si la hubieras pagado: en un caso real, $882.000 que el banco nunca te cobro figuraban como pagados. Ahora esa fila dice "Anulada", con su propio distintivo.',
    'Y no se confunde con una devolucion, que es otra cosa: una anulacion nunca entro al extracto, mientras que en una devolucion el banco si te cobro y despues te acredito el dinero. Cada una tiene su etiqueta. Sobre una compra anulada tampoco se te ofrece ya el boton de reversar, porque las dos cosas no se acumulan.',
    'Y LA TARJETA "ME DEBEN" DEJA DE COBRAR LO QUE EL BANCO ANULO. Si la compra anulada era de un responsable, la aplicacion seguia sumandotela como deuda suya: en tu caso, $882.000 que el banco nunca facturo aparecian en esa tarjeta, mientras la pestaña Terceros ya no los mostraba. Las dos pantallas se contradecian; ahora las dos dicen lo mismo.',
  ],
  '6.4.0': [
